...
<body>
    ...
    <div class="container">
        <div class="book-img">
            <img src="../assets/buku3.png" alt="Book Cover">
        </div>

        <div class="info-box">
            <h2>All-Star Western, Volume 1: Guns and Gotham</h2>
            <div class="author">By <u>Justin Gray</u></div>

            <div class="stars">★★★★☆ 4,31</div>

            <div class="desc">
                After the Civil War, the sinister Oliander Hume hunts for a powerful magical
                 revolver—now in the hands of Becky Montcrief and gunslinger Drake Sinclair—pulling them
                  into a deadly fight for legendary power.
            </div>
